...
> ⚠️ **已更新（2026-08-21）**：增训路线已定稿为 [语义VAD-SoulX增训方案.md](语义VAD-SoulX增训方案.md)（基于 SoulX-Duplug 官方 training-code 增训，含完整数据/训练/评测/部署设计）。本文档为自研路线对照版（保留作备选与设计依据）。
>
> 版本：v1.0（自研路线，已被 SoulX 增训方案取代）
> 更新：2026-08-21
